  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-white">
      ...
      <section className="flex flex-col items-center justify-center text-center pt-24 sm:pt-32 pb-16 px-4 min-h-[80vh]">
        <h1
          className={`text-4xl sm:text-6xl font-bold text-gray-800 mb-6 tracking-tight transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
        >
          Welcome to Student Portal
        </h1>
        <p
          className={`text-lg sm:text-2xl text-gray-600 mb-10 max-w-2xl mx-auto transition-all duration-1000 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
        >
          Ignite your learning journey with tools, community, and inspiration.
        </p>
        <div
          className={`flex flex-col gap-4 transition-all duration-1000 delay-400 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
            }`}
        >
      ...
      <section className="py-16 sm:py-20 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8">
          <div
            className={`bg-white rounded-xl p-8 text-center shadow-md transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
          ...
          <div
            className={`bg-white rounded-xl p-8 text-center shadow-md transition-all duration-700 delay-400 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
              } hover:shadow-xl hover:scale-105`}
          >
          ...
          <div
            className={`bg-white rounded-xl p-8 text-center shadow-md transition-all duration-700 delay-600 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
              } hover:shadow-xl hover:scale-105`}
          >
